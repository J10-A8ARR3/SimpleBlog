...
const Login: React.FC<LoginProps> = ({ onLogin }) => {
  ...
  return (
    <div className="max-w-md mx-auto mt-20 p-6 sm:p-8 border border-gray-300 rounded-lg shadow-md">
      <h2 className="text-2xl font-semibold mb-6 text-center sm:text-left">Login</h2>

      {/* Error Message */}
      {errorMsg && (
        <div className="mb-4 p-3 bg-red-100 text-red-700 border border-red-400 rounded relative text-sm sm:text-base">
          {errorMsg}
          <button
